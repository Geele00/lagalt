...
public class ChannelController {
  ...
  //         return ResponseEntity.created(URI.create("/api/channels/" +
  // savedChannel.getId())).body(savedChannel);
  //     }
  //
  //     @GetMapping("")
  ...
  //
  //     @PutMapping("/{id}")
  //     public ResponseEntity<ChannelDto> updateChannel(@PathVariable("id") int id, @RequestBody
